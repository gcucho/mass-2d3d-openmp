...
#include "../../PruebaQTMass1/thread.h"
...
QT_MOC_LITERAL(7, 77, 12)
    ...
    "Thread\0valueDisplayChanged\0\0"
    "UpdateMassOutput\0double*\0UpdateParams\0"
...
static const uint qt_meta_data_Thread[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, 0x80000000 | 4, 0x80000000 | 4, 0x80000000 | 4, 0x80000000 | 4,    2,    2,    2,    2,
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->UpdateMassOutput((*reinterpret_cast< double*(*)>(_a[1])),(*reinterpret_cast< double*(*)>(_a[2])),(*reinterpret_cast< double*(*)>(_a[3])),(*reinterpret_cast< double*(*)>(_a[4]))); break;
        case 2: _t->UpdateParams((*reinterpret_cast< DataParam*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Thread::*_t)(double * , double * , double * , double * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::UpdateMassOutput)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 1
void Thread::UpdateMassOutput(double * _t1, double * _t2, double * _t3, double * _t4)
{
